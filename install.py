...
curr.execute("CREATE TABLE IF NOT EXISTS Listeners (id INTEGER NOT NULL PRIMARY KEY, Name TEXT, Type TEXT, Config TEXT);")
curr.execute("CREATE TABLE IF NOT EXISTS Stagers (Id INTEGER NOT NULL PRIMARY KEY, Name TEXT, ListenerId INTEGER)")
conn.commit()
