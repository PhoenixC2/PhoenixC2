...
curr.execute("CREATE TABLE IF NOT EXISTS Listeners (id INTERGER PRIMARY KEY, Name TEXT, Type TEXT, Config TEXT);")
curr.execute("CREATE TABLE IF NOT EXISTS Stagers (id INTERGER PRIMARY KEY, Name TEXT, Type TEXT, Payload TEXT, ListenerId INTEGER, Encoder TEXT);")
